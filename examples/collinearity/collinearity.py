...
def orientation_by_fraction(p, q, r):
...
def graphical():
    ...
    bmp.write_grayscale('../../tmp/above_below_float.bmp', pixels)


def graphical_rational():
    """
    Test whether points immediately above and below the point (0.5, 0.5)
    lie above, on, or below the line through (12.0, 12.0) and (24.0, 24.0).
    """
    ...
    pixels = [[color[orientation_by_fraction((px, py), q, r)] for px in pys]
              for py in reversed(pys)]

    bmp.write_grayscale('../../tmp/above_below_rational.bmp', pixels)
