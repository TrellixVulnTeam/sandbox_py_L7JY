...
class ShippingContainer:
    ...
    def create_empty(cls, owner_code, length_ft, **kwargs):
        """Factory method as 'Named constructor'"""
    ...
    def __init__(self, owner_code, length_ft, contents, **kwargs):
        ...
        self.bic = self._make_bic_code(  # polymorphic dispatching static method by 'self'
...
class RefrigeratedShippingContainer(ShippingContainer):
    ...
    # propertyをoverrideするのではなく、normal methodをoverride
    def _calc_volume(self):
