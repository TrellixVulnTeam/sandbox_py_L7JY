...
style.configure('TButton', foreground='blue')  # default button theme "TButton"

# custom theme inherited from the existing theme
style.configure('Alarm.TButton', font=('Arial', 24, 'bold'))
