"""
Simulate functional programming language's Pattern Matching
"""
from functools import singledispatch
# from typing import Sequence
from collections.abc import Sequence  # workaround for 3.7
...
class Match:
    ...
    def __or__(self, pattern):
        ...
        return self if self._matched else pattern
    ...
    def __rshift__(self, pattern):
        ...
        if self._matched and not self._returned_result:
            self._result = pattern(self._match)
